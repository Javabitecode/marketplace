...
public class UriConstants {
    ...
    public static final String ADD_PRODUCT_TO_SHOP = SHOPS + SHOP_ID + CATEGORIES + CATEGORY_ID;
    public static final String UPDATE_PRODUCT = PRODUCT_ID + SHOPS + SHOP_ID + CATEGORIES + CATEGORY_ID;
